...
<div  class="text-center" style="padding-left:25px;padding-right:25px;">
  ...
  <div class="table-responsive">   
	...
	<%out.println("<td><button><a href=CupdateProject.jsp?projectID="+resultSet.getString("projectID")+ ">Update</a></button></td>");
	%>
	<%out.println("<td><button><a href=CprojectDelete.jsp?projectID="+resultSet.getString("projectID")+ " onclick=\"return confirm"+
...
<div class="text-left">
       <a href="CProjectEdit.jsp"> <button type="button" class="btn btn-default btn-sm">
