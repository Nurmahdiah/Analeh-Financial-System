...
<table class="table">
	...
	<td><a href="FupdateExpense.jsp?id=<%=resultSet.getString("id")%>"><button>Update</button></a></td>
	</tr>
	<%
	}
	con.close();
...
<div class="text-left">
       <a href="Fexpense.jsp"> <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-plus-sign"></span> New Expenses
        </button></a></div>
</div>
