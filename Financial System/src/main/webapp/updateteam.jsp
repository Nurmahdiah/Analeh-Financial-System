...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
	...
	<%
  	String teamId = request.getParameter("staffid");
  	String staffid="",fullname="", ic="", email="", phone="", roles="";
   ...
   String myQuery="select * from team where staffid="+teamId;
   ResultSet myResultSet=myStatement.executeQuery(myQuery);
   
   while(myResultSet.next()){

   fullname=myResultSet.getString(2);
   ic=myResultSet.getString(3);
   email=myResultSet.getString(4);
   phone=myResultSet.getString(5);
   roles=myResultSet.getString(6);
    }
     myConnection.close();
  %>
...
<p>/Teams/Update Teams</p></div>

  
  <div class="container text-center">
    <h3>Update Team Information</h3>
      <div class="container">
       <form action="updateteam2.jsp" method="post">
  		<input type="hidden" name="hidid" value="<%=teamId%>"/>
		<table>
    <tr>
	...
	<tr>
		...
		<td><input  class="form-control" type="text" name="ic" value="<%=ic%>"/> </td> 
	</tr>
	<tr>
		<th><label>Email</label></th>
		<td><input  class="form-control" type="text" name="email" value="<%=email%>" readonly/> </td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input  class="form-control" id="roles" type="text" name="roles" value="<%=roles%>" readonly/>
		 </td>
	...
	<input style="background-color:black; color:white;"  type="reset" value="Cancel"
				onclick="window.location.href='teamView.jsp'; return false;"/>
				</div>
</form>
</div>
      </div>
