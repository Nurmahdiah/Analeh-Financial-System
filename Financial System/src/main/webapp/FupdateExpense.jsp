...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
	...
	<%
		...
		String sequal = "Select * from expense where id="+id;
...
<table class="table">
 ...
 <td>
  <input class="form-control"  type="text" readonly name="projname" value="<%=pn%>"/>
  <input class="form-control"  type="text" list="project" name="projname"  />
  <datalist id="project">
  <option  name="projname" value="<%=pn%>" >
  	<%
		Class.forName("com.mysql.jdbc.Driver"); 
  ...
  <td><input class="form-control"  type="date" name="date" value="<%=date%>"/></td>
  </tr>
  <tr>
  <th><label>Expenses Month</label></th>
  <td>
  ...
  <td><input class="form-control" type="text" name="year" value="<%=year%>"/></td>
  </tr>
  <tr>
  <th>Expenses Amount</th>
  <td><input class="form-control" type="text" name="amount" readonly value="<%=amount%>"/></td>
  </tr>
    <tr>
  <th><label>Additional Information : </label></th>
  <td><input class="form-control"  type="text" name="desc" value="<%=desc%>"/></td>
  </tr>
  </table>
	...
	<input style="background-color:black; color:white;" type="submit" value="Cancel"
			onclick="window.location.href='FexpenseView.jsp'; return false;"/>
</form>
