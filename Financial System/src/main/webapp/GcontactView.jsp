...
<div  class="text-center" style="padding-left:25px;padding-right:25px;">
  ...
  <table class="table">
	...
	<%out.println("<td><button><a href=GprocessUpdateContact.jsp?contID="+resultSet.getString("contID")+">Update</a></button></td>");
	%>
	<%out.println("<td><button><a href=GprocessDeleteContact.jsp?contID="+resultSet.getString("contID")+ " onclick=\"return confirm"+
...
<div class="text-left">
       <a href="GcontactAdd.html"> <button type="button" class="btn btn-default btn-sm">
