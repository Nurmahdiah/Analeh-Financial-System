...
<div  class="container text-center" style="padding-left:25px;padding-right:25px;">
  ...
  <div class="table-responsive">   
        ...
        <%
            ...
            String myQuery = "SELECT * FROM team";
            ...
            <td><%=myResultSet.getString(3)%></td>
            <td><%=myResultSet.getString(4)%></td>
            <td><%=myResultSet.getString(5)%></td>
            <td><%=myResultSet.getString(6)%></td>
            <%out.print("<td> <button> <a href=updateteam.jsp?staffid="+ myResultSet.getString(1)+ ">Update</a></button></td>");
              out.print("<td> <button> <a href=deleteteam.jsp?staffid="+ myResultSet.getString(1)+ "  onclick=\"return confirm"+
...
<div class="text-left">
       <a href="team.jsp"> <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-plus-sign"></span> New Team Member
        </button></a></div></div>
<div class="container">
