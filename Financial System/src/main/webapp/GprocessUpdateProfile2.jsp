...
<body>
	...
	<%
		...
		String sql = "Update gProfile set role=?,username=?,phoneNo=?,icNo=?,emailAddress=?,password=? where id="+profileId;
		...
		RequestDispatcher rd = request.getRequestDispatcher("GvProfile.jsp");
