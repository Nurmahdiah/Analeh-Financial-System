...
<body>
	...
	<%
		...
		String sql = "Update cProfile set role=?,username=?,phoneNo=?,icNo=?,emailAddress=?,password=? where id="+profileId;
		...
		RequestDispatcher rd = request.getRequestDispatcher("CvProfile.jsp");
