...
<p>Invoice/New Invoice Details</p></div>

  <div class="container text-center">
   <h3>New Invoice Details</h3>
		    <form action="invoiceNewProcess.jsp" method="post">
    <div class="table-responsive">
<table class="table">
 <tr>
 <th><label>Receiver Name  </label></th>
 <td>
  <input class="form-control" type="text" name="rcvr"  />
  </td>
  </tr>
   <tr>
 <th><label>Receiver Address </label></th>
 <td>
  <input class="form-control" type="text" name="addr"  />
  </td>
  </tr>
  <tr>
  <th><label>Invoice Description</label></th>
 <td>
 ...
 <th><label>Project Name </label></th>
  ...
  <input class="form-control" type="date" name="date"  />
	...
	<input style="background-color:black; color:white;"type="submit" value="Cancel"
			onclick="window.location.href='invoiceView.jsp'; return false;"/>
			</div>
</form>
      </div> 
