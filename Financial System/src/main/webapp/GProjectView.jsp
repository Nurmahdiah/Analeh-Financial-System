...
<div  class="text-center" style="padding-left:25px;padding-right:25px;">
  ...
  <div class="table-responsive">   
	...
	<%out.println("<td><button><a href=GupdateProject.jsp?projectID="+resultSet.getString("projectID")+ ">Update</a></button></td>");
	%>
	<%out.println("<td><button><a href=GprojectDelete.jsp?projectID="+resultSet.getString("projectID")+ " onclick=\"return confirm"+
...
<div class="text-left">
       <a href="GProjectEdit.jsp"> <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-plus-sign"></span> New Projects
        </button></a></div></div>
<div class="container">
