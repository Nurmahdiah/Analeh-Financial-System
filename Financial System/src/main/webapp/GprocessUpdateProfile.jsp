...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
	...
	<%
		...
		String sql = "Select * from gProfile where id="+profileId;
...
<p>/Profile/Update Profile</p></div>
  ...
  <div class="container text-center">
    <h3>Update Profile</h3>
      <div class="container">
        <form action="GprocessUpdateProfile2.jsp" method="post">
	...
	<input style="background-color:black; color:white;" type="reset" value="Cancel"
				onclick="window.location.href='GvProfile.jsp'; return false;"/>
				</div>
</form>
</div>
      </div> 
