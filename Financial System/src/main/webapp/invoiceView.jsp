...
<p>/Invoices/Generate Monthly Invoices</p></div>
...
<label>Project Name : </label>
  		<input class="form-control" type="text" list="project" name="pjname"  />
		  <datalist id="project">
...
<label>Invoice Number : </label><input  class="form-control"type="text" name="ivno" placeholder= eg:INV/ALE/001/>
<label>Year : </label><input  class="form-control" type="text" name="year" placeholder= eg:2021/>
...
<br><br>
<input style="background-color:black; color:white;" type="submit" value="Search"/>
