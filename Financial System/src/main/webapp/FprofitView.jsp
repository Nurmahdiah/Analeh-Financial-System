...
<div  class="text-center" style="padding-left:25px;padding-right:25px;">
  ...
  <div class="table-responsive">   
	...
	String k = "Select * from profit where month='"+month+"' and year='"+year+"'";
...
<div class="text-left">
       <a href="FprofitViews.jsp"> <button type="button" class="btn btn-default btn-sm">
          <span class="glyphicon glyphicon-plus-sign"></span> View All Monthly Profits
        </button></a></div>
</div>
<div class="container">
