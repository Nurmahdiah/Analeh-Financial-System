...
<div  class="container text-center" style="padding-left:25px;padding-right:25px;">
  <h3> Monthly Profit Details </h3> 
  <p><em></em></p>
   <form action="FprofitProcess.jsp" method="post">
<label>Year : </label><input class="form-control" type="text" name="id" placeholder= eg:2021/>
...
<br><br>
<input style="background-color:black; color:white;" type="submit" value="Calculate Profit"/> &nbsp;
<input style="background-color:black; color:white;" type="reset" value="Cancel"
				onclick="window.location.href='FprofitViews.jsp'; return false;"/>
</form>
