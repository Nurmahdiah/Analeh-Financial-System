...
<p>/Profiles</p></div>
  ...
  <div class="container text-center">
	...
	String sql = "Select * from cProfile";
	...
	<tr>
	<td style="padding-left:20px;"><br><br><a href="CprocessUpdateProfile.jsp?id=<%=resultSet.getString("id")%>"><button class="btn btn-primary" type="submit">Update</button></a></td>
</tr>
	<%
	}
	con.close();
