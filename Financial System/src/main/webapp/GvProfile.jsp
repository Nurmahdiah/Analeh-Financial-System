...
<p>/Profiles</p></div>
  ...
  <div class="container text-center">
	...
	String sql = "Select * from gProfile";
	...
	<tr>
	<td style="padding-left:20px;"><br><br><a href="GprocessUpdateProfile.jsp?id=<%=resultSet.getString(1)%>"><button class="btn btn-primary" type="submit">Update</button></a></td>
</tr>
	<%
	}
	con.close();
