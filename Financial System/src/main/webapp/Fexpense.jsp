...
<table class="table">
 ...
 <td>
  ...
  <td><input class="form-control" type="date" name="date" placeholder="Ex:January 10, 2021"/></td>
  </tr>
  <tr>
  ...
  <td><input class="form-control" type="text" name="year" placeholder="eg:2021"/></td>
  </tr>
  <tr>
  <th>Monthly Expenses Amount</th>
  <td><input  class="form-control" type="text" name="amount" placeholder="RM0.0"/></td>
  </tr>
    <tr>
  <th><label>Additional Information : </label></th>
  <td><input class="form-control" type="text" name="desc" placeholder="eg:total expenses for july"/></td>
  </tr>
  </table>
